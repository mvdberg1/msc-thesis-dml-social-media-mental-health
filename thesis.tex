...
\input{tables/table_sample_composition.tex}
...
\input{tables/table_linear_benchmark_ols_life.tex}
...
\input{tables/table_panel_model_tests.tex}
...
\input{tables/table_dml_life_methods.tex}
...
\input{tables/table_irm_life_methods.tex}
...
\input{tables/table_fe_dml_comparison.tex}
...
\input{tables/table_robustness_weekend.tex}
...
\input{tables/table_robustness_extended_waves.tex}
...
\begin{figure}[p]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth,height=0.76\textheight,keepaspectratio]{figures/results_chapter_summary.png}}
...
\begin{figure}[p]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth,height=0.76\textheight,keepaspectratio]{figures/results_chapter_summary_robustness.png}}
...
\input{tables/table_linear_benchmark_ols_loneliness.tex}

\input{tables/table_linear_benchmark_ols_schoolwork.tex}

\input{tables/table_linear_benchmark_ols_school.tex}
...
\input{tables/table_dml_schoolwork_methods.tex}
...
\input{tables/table_irm_school_methods.tex}
...
\input{tables/table_fe_dml_comparison_loneliness.tex}

\input{tables/table_fe_dml_comparison_schoolwork_dissatisfaction.tex}

\input{tables/table_fe_dml_comparison_school_dissatisfaction.tex}
...
\input{tables/table_robustness_leave_one_wave_out.tex}

\input{tables/table_robustness_repeated_cross_fitting.tex}
...
\input{tables/table_robustness_irm_trimming.tex}

\input{tables/table_robustness_plr_sensitivity.tex}
