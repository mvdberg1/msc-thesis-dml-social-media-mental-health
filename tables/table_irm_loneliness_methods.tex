\begin{table}[!htbp]
\centering
\caption{Interactive regression model double machine learning estimates for loneliness across nuisance learners}
\label{tab:irm_loneliness_methods}
\begin{tabular}{lccc}
\hline
Variable & Elastic net & Lasso & Random forest
\\
\hline
High social-media use & 0.057 & 0.055 & 0.041
\\
 & (0.069) & (0.053) & (0.038)
\\
N & 4,298 & 4,298 & 4,298
