\begin{table}[!htbp]
\centering
\caption{Partially linear double machine learning estimates for school dissatisfaction across nuisance learners}
\label{tab:dml_school_methods}
\begin{tabular}{lcccc}
\hline
Variable & Elastic net & Lasso & Random forest & Neural net
\\
\hline
Weekday social-media use & 0.075** & 0.072** & 0.078** & 0.074**
\\
