\begin{table}[!htbp]
\centering
\caption{Partially linear double machine learning estimates for loneliness across nuisance learners}
\label{tab:dml_loneliness_methods}
\begin{tabular}{lcccc}
\hline
Variable & Elastic net & Lasso & Random forest & Neural net
\\
\hline
Weekday social-media use & 0.024* & 0.022* & 0.024* & 0.017
\\
