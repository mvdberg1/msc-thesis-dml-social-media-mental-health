\begin{table}[!htbp]
\centering
\caption{Interactive regression model double machine learning estimates for school-work dissatisfaction across nuisance learners}
\label{tab:irm_schoolwork_methods}
\begin{tabular}{lccc}
\hline
Variable & Elastic net & Lasso & Random forest
\\
\hline
High social-media use & 0.501*** & 0.551*** & 0.506***
\\
 & (0.116) & (0.133) & (0.109)
\\
N & 4,329 & 4,329 & 4,329
